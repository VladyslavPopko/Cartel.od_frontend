import description_item1_logo from "../../img/_Landliz_Drop/Landliz_Drop68/descriptionImg1.svg";
import description_item2_logo from "../../img/_Landliz_Drop/Landliz_Drop68/descriptionImg2.svg";
import description_item3_logo from "../../img/_Landliz_Drop/Landliz_Drop68/descriptionImg3.svg";
import description_item4_logo from "../../img/_Landliz_Drop/Landliz_Drop68/descriptionImg4.svg";

//import aboutusItem1Img from "../../img/_Landliz_Drop/Landliz_Drop68/aboutUsImg1.svg";
//import aboutusItem2Img from "../../img/_Landliz_Drop/Landliz_Drop68/aboutUsImg2.svg";

import reviewItem1Img from "../../img/_Landliz_Drop/Landliz_Drop68/reviewImg1.png";
import reviewItem2Img from "../../img/_Landliz_Drop/Landliz_Drop68/reviewImg2.png";
import reviewItem3Img from "../../img/_Landliz_Drop/Landliz_Drop68/reviewImg3.png";

// import advantageItem1Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg1.svg";
// import advantageItem2Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg2.svg";
// import advantageItem3Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg3.svg";
// import advantageItem4Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg4.svg";
// import advantageItem5Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg5.svg";
// import advantageItem6Img from "../../img/_Landliz_Drop/Landliz_Drop68/advantageImg6.svg";

//import table from "../../img/_Landliz_Drop/Landliz_Drop68/table.jpg";

const price = 999; // необходимо для формулы высчета скидки за несколько товаров

export const CONTENT = {
  sizeArray: [
    { id: 1, value: "36", active: true },
    { id: 2, value: "37", active: true },
    { id: 3, value: "38", active: true },
    { id: 4, value: "39", active: true },
    { id: 5, value: "40", active: true },
    { id: 6, value: "41", active: true },
    { id: 7, value: "42", active: true },
    { id: 8, value: "43", active: true },
    { id: 9, value: "44", active: true },
    { id: 10, value: "45", active: true },
    { id: 11, value: "46", active: true },
  ],
  contentHero: {
    price: "999",
    old_price: "1 299",
...
export const CONTENT_LANDLIZ_DROP_68 = CONTENT; // Поменять на имя, используемое для файла data
