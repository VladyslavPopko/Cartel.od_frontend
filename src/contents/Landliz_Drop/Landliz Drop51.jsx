import description_item1_logo from "../../img/_Landliz_Drop/Landliz_Drop51/descriptionImg1.svg";
import description_item2_logo from "../../img/_Landliz_Drop/Landliz_Drop51/descriptionImg2.svg";
import description_item3_logo from "../../img/_Landliz_Drop/Landliz_Drop51/descriptionImg3.svg";
import description_item4_logo from "../../img/_Landliz_Drop/Landliz_Drop51/descriptionImg4.svg";

//import aboutusItem1Img from "../../img/_Landliz_Drop/Landliz_Drop51/aboutUsImg1.svg";
//import aboutusItem2Img from "../../img/_Landliz_Drop/Landliz_Drop51/aboutUsImg2.svg";

import reviewItem1Img from "../../img/_Landliz_Drop/Landliz_Drop51/reviewImg1.png";
import reviewItem2Img from "../../img/_Landliz_Drop/Landliz_Drop51/reviewImg2.png";
import reviewItem3Img from "../../img/_Landliz_Drop/Landliz_Drop51/reviewImg3.png";

// import advantageItem1Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg1.svg";
// import advantageItem2Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg2.svg";
// import advantageItem3Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg3.svg";
// import advantageItem4Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg4.svg";
// import advantageItem5Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg5.svg";
// import advantageItem6Img from "../../img/_Landliz_Drop/Landliz_Drop51/advantageImg6.svg";

//import table from "../../img/_Landliz_Drop/Landliz_Drop51/table.jpg";

const price = 999; // необходимо для формулы высчета скидки за несколько товаров

export const CONTENT = {
  sizeArray: [
    { id: 1, value: "48", active: true },
    { id: 2, value: "50", active: true },
    { id: 3, value: "52", active: true },
    { id: 4, value: "54", active: true },
    { id: 5, value: "56", active: true },
...
export const CONTENT_LANDLIZ_DROP_51 = CONTENT; // Поменять на имя, используемое для файла data
