import aboutImg1 from "../../img/_Slavs_Drop/ziphoodie_SI/aboutImg1.png";
import aboutImg2 from "../../img/_Slavs_Drop/ziphoodie_SI/aboutImg2.png";
...
import aboutusItem1Img from "../../img/_Slavs_Drop/ziphoodie_SI/aboutUsImg1.svg";
import aboutusItem2Img from "../../img/_Slavs_Drop/ziphoodie_SI/aboutUsImg2.svg";

import reviewItem1Img from "../../img/_Slavs_Drop/ziphoodie_SI/reviewImg1.png";
import reviewItem2Img from "../../img/_Slavs_Drop/ziphoodie_SI/reviewImg2.png";
import reviewItem3Img from "../../img/_Slavs_Drop/ziphoodie_SI/reviewImg3.png";

import advantageItem1Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg1.svg";
import advantageItem2Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg2.svg";
import advantageItem3Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg3.svg";
import advantageItem4Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg4.svg";
import advantageItem5Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg5.svg";
import advantageItem6Img from "../../img/_Slavs_Drop/ziphoodie_SI/advantageImg6.svg";
...
export const CONTENT = {
  ...
  contentReview: {
    ...
    item1_name: "Марія",
    item1_text: "Дуже якісна тканина, хлопець у захваті.",
    item2_name: "Микола",
    item2_text: "Мій улюблений колір - антрацит. Гарно виглядає!",
    item3_name: "Дар’я",
    item3_text:
      "Замовила собі рожевий колір. Дуже насичений, прання не шкодить.",
  },
  contentGallery: {
    title: "Галерея",
  },
