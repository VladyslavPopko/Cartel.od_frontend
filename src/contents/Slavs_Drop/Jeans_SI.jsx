// import aboutImg1 from "../../img/_Slavs_Drop/Jeans_SI/aboutImg1.png";
// import aboutImg2 from "../../img/_Slavs_Drop/Jeans_SI/aboutImg2.png";

import description_item1_logo from "../../img/_Slavs_Drop/Jeans_SI/descriptionImg1.svg";
import description_item2_logo from "../../img/_Slavs_Drop/Jeans_SI/descriptionImg2.svg";
import description_item3_logo from "../../img/_Slavs_Drop/Jeans_SI/descriptionImg3.svg";
import description_item4_logo from "../../img/_Slavs_Drop/Jeans_SI/descriptionImg4.svg";

import aboutusItem1Img from "../../img/_Slavs_Drop/Jeans_SI/aboutUsImg1.svg";
import aboutusItem2Img from "../../img/_Slavs_Drop/Jeans_SI/aboutUsImg2.svg";

import reviewItem1Img from "../../img/_Slavs_Drop/Jeans_SI/reviewImg1.png";
import reviewItem2Img from "../../img/_Slavs_Drop/Jeans_SI/reviewImg2.png";
import reviewItem3Img from "../../img/_Slavs_Drop/Jeans_SI/reviewImg3.png";

import advantageItem1Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg1.svg";
import advantageItem2Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg2.svg";
import advantageItem3Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg3.svg";
import advantageItem4Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg4.svg";
import advantageItem5Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg5.svg";
import advantageItem6Img from "../../img/_Slavs_Drop/Jeans_SI/advantageImg6.svg";
...
export const CONTENT = {
  sizeArray: [
    ...
    { id: 2, value: "32", active: true },
    { id: 3, value: "34", active: true },
    { id: 4, value: "36", active: true },
  ],
  contentHero: {
    price: "2 799",
    old_price: "3 499",
  ...
  contentReview: {
    ...
    item1_name: "Олег",
    item1_text: "Все сподобалось",
    item2_name: "Владислав",
    item2_text: "Ну і навіщо переплачувати?",
    item3_name: "Микита",
    item3_text: "Відносив 2 сезони, все добре",
  },
  contentGallery: {
    title: "Галерея",
  },
...
export const CONTENT_SLAVS_DROP_Jeans_SI = CONTENT; // Поменять на имя, используемое для файла data
