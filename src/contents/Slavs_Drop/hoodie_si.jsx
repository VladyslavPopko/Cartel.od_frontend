import aboutImg1 from "../../img/_Slavs_Drop/hoodie_SI/aboutImg1.png";
import aboutImg2 from "../../img/_Slavs_Drop/hoodie_SI/aboutImg2.png";

import description_item1_logo from "../../img/_Slavs_Drop/hoodie_SI/descriptionImg1.svg";
import description_item2_logo from "../../img/_Slavs_Drop/hoodie_SI/descriptionImg2.svg";
import description_item3_logo from "../../img/_Slavs_Drop/hoodie_SI/descriptionImg3.svg";
import description_item4_logo from "../../img/_Slavs_Drop/hoodie_SI/descriptionImg4.svg";

import aboutusItem1Img from "../../img/_Slavs_Drop/hoodie_SI/aboutUsImg1.svg";
import aboutusItem2Img from "../../img/_Slavs_Drop/hoodie_SI/aboutUsImg2.svg";

import reviewItem1Img from "../../img/_Slavs_Drop/hoodie_SI/reviewImg1.png";
import reviewItem2Img from "../../img/_Slavs_Drop/hoodie_SI/reviewImg2.png";
import reviewItem3Img from "../../img/_Slavs_Drop/hoodie_SI/reviewImg3.png";

import advantageItem1Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg1.svg";
import advantageItem2Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg2.svg";
import advantageItem3Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg3.svg";
import advantageItem4Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg4.svg";
import advantageItem5Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg5.svg";
import advantageItem6Img from "../../img/_Slavs_Drop/hoodie_SI/advantageImg6.svg";

import table from "../../img/_Slavs_Drop/hoodie_SI/table.jpg";
...
export const CONTENT = {
  ...
  contentAbout: {
    ...
    second_title: "ХУДІ з додатковою знижкою",
    subtitle_first_img: aboutImg1,
    subtitle_second_img: aboutImg2,
    subtitle_first_text1: "пРИ ЗАМОЛВЕННІ ",
    subtitle_first_text2: "2 ХУДІ",
    subtitle_first_text3: " ЗНИЖКА:",
    subtitle_first_old_price: "4 498 ₴",
    subtitle_first_price: "4 048 ₴",
    subtitle_first_value: "-10%",
    subtitle_second_text1: "пРИ ЗАМОЛВЕННІ ",
    subtitle_second_text2: "3 ХУДІ",
    subtitle_second_text3: " ЗНИЖКА:",
    subtitle_second_old_price: "6 747 ₴",
    subtitle_second_price: "5 738 ₴",
    subtitle_second_value: "-15%",
    radio_first: "1 худі 2 249 ₴",
    radio_second_1: "2 худі",
    radio_second_2: " 4 048",
  ...
  contentReview: {
    ...
    item1_name: "Іван",
    item1_text: "Тепер це мое найулюбленіше худі.",
    item2_name: "Ксенія",
    item2_text: "Закохалась в червоний колір",
    item3_name: "Володимир",
    item3_text: "Дякую за якість, замовлятиму ще.",
  },
  contentGallery: {
    title: "Галерея",
  },
...
export const CONTENT_SLAVS_DROP_HOODIE_SI = CONTENT; // Поменять на имя, используемое для файла data