...
const name = "Тактична флісова кофта мультикам Han-Wild"; // Пишется в корзине товара
const main_title = "Тактична флісова кофта мультикам Han-Wild"; // Пишется в фильтре на главной странице и в каталоге
