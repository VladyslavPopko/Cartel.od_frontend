...
import Img1_galery_img1 from "../../img/_Landliz_Drop/Landliz_Drop9/img1_galery_img1.jpg";
import Img1_galery_img2 from "../../img/_Landliz_Drop/Landliz_Drop9/img1_galery_img2.jpg";
import Img1_galery_img3 from "../../img/_Landliz_Drop/Landliz_Drop9/img1_galery_img3.jpg";
import Img1_galery_img4 from "../../img/_Landliz_Drop/Landliz_Drop9/img1_galery_img4.jpg";
...
const category = "Безрукавки"; // Категория (для фильтра на главной странице)
const name = "Безрукавка піксель"; // Пишется в корзине товара
const main_title = "Безрукавка піксель"; // Пишется в фильтре на главной странице и в каталоге
...
export const INFO_LANDLIZ_DROP_9 = {
