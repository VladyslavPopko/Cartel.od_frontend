...
import Img1_galery_img1 from "../../img/_Landliz_Drop/Landliz_Drop37/img1_gallery_img1.jpg";
import Img1_galery_img2 from "../../img/_Landliz_Drop/Landliz_Drop37/img1_gallery_img2.jpg";
import Img1_galery_img3 from "../../img/_Landliz_Drop/Landliz_Drop37/img1_gallery_img3.jpg";
// from "../../img/_Landliz_Drop/Landliz_Drop37/img1_gallery_img4.jpg";
...
const name = "Рюкзак тактичний піксель 35л"; // Пишется в корзине товара
const main_title = "Рюкзак тактичний піксель 35л"; // Пишется в фильтре на главной странице и в каталоге
const VENDOR_NAME = "Landliz Drop"; // Поставщик
const price = 999; // цена по которой продаем
const old_price = 1299; // цена скидки
const page = "/military/backpacks/backpacs/4"; // на какой странице находится товар

// Как товары называются в CRM
const full_name1 = "Рюкзак тактичний піксель 35л";
